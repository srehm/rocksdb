...
void rocksdb_transactiondb_options_set_write_policy(
    rocksdb_transactiondb_options_t* opt, int policy) {
  switch (policy) {
    case rocksdb_write_policy_committed:
      opt->rep.write_policy = rocksdb::TxnDBWritePolicy::WRITE_COMMITTED;
      break;
    case rocksdb_write_policy_prepared:
      opt->rep.write_policy = rocksdb::TxnDBWritePolicy::WRITE_PREPARED;
      break;
    case rocksdb_write_policy_unprepared:
...
int rocksdb_transactiondb_options_get_write_policy(
    rocksdb_transactiondb_options_t* opt) {
  switch (opt->rep.write_policy) {
    case rocksdb::TxnDBWritePolicy::WRITE_COMMITTED:
      return rocksdb_write_policy_committed;
    case rocksdb::TxnDBWritePolicy::WRITE_PREPARED:
      return rocksdb_write_policy_prepared;
    case rocksdb::TxnDBWritePolicy::WRITE_UNPREPARED:
      return rocksdb_write_policy_unprepared;
    default:
		return -1;
  }
}
